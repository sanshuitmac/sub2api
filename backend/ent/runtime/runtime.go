...
func init() {
	...
	// apikeyDescExpiryStartsOnFirstUse is the schema descriptor for expiry_starts_on_first_use field.
	apikeyDescExpiryStartsOnFirstUse := apikeyFields[12].Descriptor()
	// apikey.DefaultExpiryStartsOnFirstUse holds the default value on creation for the expiry_starts_on_first_use field.
	apikey.DefaultExpiryStartsOnFirstUse = apikeyDescExpiryStartsOnFirstUse.Default.(bool)
